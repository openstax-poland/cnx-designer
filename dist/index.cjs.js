...
function onEnter(editor, ev) {
    ...
    if (titlePath != null) {
        slate.Editor.withoutNormalizing(editor, () => {
            const nextPath = slate.Path.next(titlePath);
            slate.Transforms.splitNodes(editor);
            slate.Transforms.setNodes(editor, { type: 'paragraph' }, { at: nextPath });
            nextPath.push(0);
    ...
    if (slate.Range.isCollapsed(selection)) {
        ...
        const [container, containerPath] = (_e = slate.Editor.above(editor, {
