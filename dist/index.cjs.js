...
function onBackspace(editor, ev) {
    ...
    if (admonition != null && admonitionPath != null) {
        ...
        // Backspace in list at the beginning of an admonition. Admonition
        // should be unwrapped, but list should be preserved.
        if (listPath != null) {
            ...
            if (pointBefore && slate.Editor.above(editor, { at: pointBefore.path, match: slateLists.ListItem.isListItem }))
                return;
            slate.Transforms.unwrapNodes(editor, { at: admonitionPath });
        }
