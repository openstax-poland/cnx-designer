...
function onEnter(editor, ev) {
    ...
    const [caption, captionPath] = (_b = slate.Editor.above(editor, { match: Caption.isCaption })) !== null && _b !== void 0 ? _b : [];
    if (caption != null) {
        slate.Editor.withoutNormalizing(editor, () => {
            if (!slate.Range.isCollapsed(selection)) {
                slate.Editor.deleteFragment(editor);
    ...
    if (slate.Range.isCollapsed(selection)) {
        ...
        const [container, containerPath] = (_c = slate.Editor.above(editor, {
