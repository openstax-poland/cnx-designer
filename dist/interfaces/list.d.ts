...
export declare type Bullet = 'bullet' | 'open-circle' | 'pilcrow' | 'rpilcrow' | 'asterisk' | 'dash' | 'section' | 'none';
/** An enumerated list */
...
export declare type NumberStyle = 'arabic' | 'upper-alpha' | 'lower-alpha' | 'upper-roman' | 'lower-roman';
