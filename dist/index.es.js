import { Element, Editor, Range, Transforms as Transforms$1, Path, Node, Text } from 'slate';
...
function onEnter(editor, ev) {
    ...
    if (isCodeLike(block)) {
        Editor.withoutNormalizing(editor, () => {
            ...
            Transforms$1.setNodes(editor, { type: 'paragraph' }, { at: paraPath });
            Transforms$1.unsetNodes(editor, 'placement', { at: paraPath });
        });
        return ev.preventDefault();
    }
