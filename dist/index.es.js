...
function normalizeTable(editor, entry) {
    ...
    if (Table.isTable(node)) {
        ...
        if (!Table.isColumnPosition(node.column)) {
            Transforms$1.setNodes(editor, { column: null }, { at: path });
            return true;
        }
    }
    return false;
