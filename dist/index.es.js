import { Element, Editor, Range, Transforms, Path, Text, Node } from 'slate';
...
function onEnter(editor, ev) {
    ...
    if (Range.isCollapsed(selection)) {
        ...
        const [container, containerPath] = (_d = Editor.above(editor, {
...
function addGlossaryDefinition(editor, options = {}) {
    Editor.withoutNormalizing(editor, () => {
        ...
        if (at == null)
            return;
        const toInsert = unpackBlocks(editor, Editor.fragment(editor, at));
        const node = {
            type: 'definition',
            children: [{
                    type: 'definition_term',
