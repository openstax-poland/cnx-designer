...
import { Proof, Rule, RuleExample, Section, Statement } from '../interfaces';
/**
 ...
 * line elements.
 */
export function insertRule(editor, kind, options = {}) {
 ...
 * statement.
 */
export function insertStatement(editor, options = {}) {
 ...
 */
export function insertProof(editor, options = {}) {
 ...
 * example.
 */
export function insertRuleExample(editor, options = {}) {
