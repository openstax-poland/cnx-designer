...
import { Definition, Glossary, SeeAlso } from '../interfaces';
/**
 ...
 * definition.
 */
export function addGlossaryDefinition(editor, options = {}) {
 ...
 * Does nothing if no definition is selected.
 */
export function insertMeaning(editor, options = {}) {
 ...
 * example.
 */
export function insertDefinitionExample(editor, options = {}) {
 ...
 * see-also term.
 */
export function insertSeeAlso(editor, options = {}) {
    Editor.withoutNormalizing(editor, () => {
        const { at = editor.selection, select } = options;
        if (at == null)
            return;
