...
/**
 * Properties of {@link Value} changes to which can safely be ignored.
 */
...
/**
 * Persist all important operations in a Change.
 */
export function mark(db, change) {
